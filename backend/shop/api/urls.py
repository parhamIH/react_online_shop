...
urlpatterns = [
    ...
    path("auth/send-verification-code/", views.SendVerificationCodeView.as_view(), name="api-send-verification-code"),
    path("auth/verify-code/", views.VerifyVerificationCodeView.as_view(), name="api-verify-code"),
    ...
    path("coupons/apply/", views.ApplyCouponView.as_view(), name="api-apply-coupon"),
    path("payment/request/", views.ZarinPalPaymentRequestView.as_view(), name="api-payment-request"),
    path("payment/verify/", views.ZarinPalPaymentVerifyView.as_view(), name="api-payment-verify"),
